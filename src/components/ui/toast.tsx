...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed left-0 right-0 top-0 z-[1400] flex max-h-screen w-full flex-col-reverse p-4 sm:left-auto sm:bottom-0 sm:right-0 sm:top-auto sm:flex-col md:max-w-[420px]",
      className,
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Description ref={ref} className={cn("max-h-40 overflow-y-auto break-words text-sm opacity-90", className)} {...props} />
));
